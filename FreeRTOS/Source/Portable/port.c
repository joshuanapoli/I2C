...
extern void ( vTickISR )( void );
	...
	/* TRC - modified "T0_PR" to be "T0PR" (use my register mnemonic) */
	...
	#endif
	/* TRC - modified "T0_MR0" to be "T0MR0" (use my register mnemonic) */
	T0MR0 = ulCompareMatch;

	/* Generate tick with timer 0 compare match. */
	/* TRC - modified "T0_MCR" to be "T0MCR" (use my register mnemonic) */
	...
	/* TRC - modified "T0_TCR" to be "T0TCR" (use my register mnemonic) */
