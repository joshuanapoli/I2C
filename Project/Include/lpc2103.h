 ...
 * lpc2103.h *
 *************
 * Defines of register mnemonics for NXP LPC2103 ARM microprocessor
 */
#ifndef LPC2103_H
#define LPC2103_H

/* Define register read/write macros - usage clarifies code
 *
 * Example:
 *
 * 		Don't use:	PLLCFG = 0x25;
 * 		Do use:		WRITE(PLLCFG) = 0x25;
 *
 * 		Don't use:	while (PLLSTAT & 0x400);
 * 		Do use:		while (READ(PLLSTAT) & 0x400);
 */
#define WRITE(address, value) (address = value)
#define READ(address) (address)

/* Register mnemonics in alphabetical order */
...
#define PCONP			(*((volatile unsigned long *) 0xE014C0C4))
